...
class Calculator
  ...
  new create() =>
    ...
    let ws = RuleRepeat[U8,ISize](
      RuleClass[U8,ISize].from_iter(" \t".values()), 0)

    // A number can be either an expression in parentheses, or a string
    // of digits.
    let num = RuleChoice[U8,ISize](
    ...
    mul.push(RuleSequence[U8,ISize](
      [ mul
        ws
        RuleChoice[U8,ISize](
    ...
    add.push(RuleSequence[U8,ISize](
      [ add
        ws
        RuleChoice[U8,ISize](
          [ RuleLiteral[U8,ISize]("+"); RuleLiteral[U8,ISize]("-") ])
